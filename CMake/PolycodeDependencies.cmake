...
LINK_DIRECTORIES(${POLYCODE_RELEASE_DIR}/Framework/Core/lib
		...
		Message(${OPENCL_LIBARY})
#		IF(OPENCL_FOUND)
#			SET(OPENCL_LIBRARY ${POLYCODE_RELEASE_DIR}/Framework/Core/Dependencies/${OPENCL_LIBRARY})
#		ENDIF(OPENCL_FOUND)
...
IF(MSVC OR MINGW)
	SET(POLYCODE_DEPENDENCY_LIBS 
		...
		IF(OPENCL_FOUND)
			SET(POLYCODE_DEPENDENCY_LIBS ${POLYCODE_DEPENDENCY_LIBS} ${OPENCL_LIBRARY})
		ENDIF(OPENCL_FOUND)
ELSEIF(APPLE)
